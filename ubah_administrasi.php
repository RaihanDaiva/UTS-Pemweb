...
">
        ...
        include 'koneksi.php';
        $id = $_GET['id'];
        $data = mysqli_query($koneksi, "select * from administrasi where id_admin='$id'");
...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                    ...
                    <table>
                        <input type="hidden" name="action" value="updateAdministrasi">
                        <tr>
                            <td class>Nama</td>
                            <td><input type="hidden" name="id_admin" value="<?php echo $d['id_admin']; ?>">
                                <input type="text" class="form-control" name="nama_admin"
                                    value="<?php echo $d['nama_admin']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Jadwal</td>
