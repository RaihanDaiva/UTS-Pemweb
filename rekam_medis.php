                                                ...
                                                <table class="table table-striped mb-0">
                                                    <thead style="background-color: #002d72;">
                                                        <tr class="judul-tabel">
                                                            ...
                                                            <th scope="col">Obat Diberikan</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        include 'koneksi.php';
                                                        $no = 1;
                                                        $query = "SELECT rekam_medis.*, 
                                                                    CONCAT(pasien.id_pasien, ' - ', pasien.nama_pasien) AS pasien_info, 
                                                                    CONCAT(dokter.id_dokter, ' - ', dokter.nama_dokter) AS dokter_info 
                                                                    FROM rekam_medis
                                                        ...
                                                        while ($d = $data->fetch_assoc()) {
                                                            ...
                                                            <tr class="data">
                                                                ...
                                                                <td class="text-dark"><?php echo $d['pasien_info']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['dokter_info']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['diagnosa']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['tanggal_kunjungan']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['tindakan_medis']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['obat_diberikan']; ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <a role="button" class="btn"
                                                                        ...
                                                                        href="ubah_rekam_medis.php?id=<?php echo $d['id_rekam_medis']; ?>">
                                                                    ...
                                                                    <a role="button" class="btn btn-danger"
                                                                        href="hapus.php?id=<?php echo $d['id_rekam_medis']; ?>&type=rekam_medis"><i
