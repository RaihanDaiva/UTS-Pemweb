                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu show bg-transparent border-0">
                            ...
                            <div class="dropdown-submenu show bg-transparent border-0">
                                <a href="dokter.php" class="dropdown-item active" style="margin-left:10px ;">Dokter</a>
...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
					...
					<table>
						<input type="hidden" name="action" value="updateDokter">
						<tr>
							<td class>Nama</td>
							<td><input type="hidden" name="id_dokter" value="<?php echo $d['id_dokter']; ?>">
								<input type="text" class="form-control" name="nama_dokter"
									value="<?php echo $d['nama_dokter']; ?>">
							</td>
						</tr>
						<tr>
							<td>No Lisensi</td>
						...
						<tr>
							<td>Spesialisasi</td>
							<td><input type="text" class="form-control" name="spesialisasi"
									value="<?php echo $d['spesialisasi']; ?>"></td>
						</tr>
						<tr>
							<td>Jadwal Praktek</td>
							<td><input type="text" class="form-control" name="jadwal_praktek"
									value="<?php echo $d['jadwal_praktek']; ?>"></td>
						</tr>
						<tr>
							<td>Kontak</td>
							...
							<td class="pt-3">
								<div class="d-flex justify-content-center gap-2 ">
									...
									<a><input style="width:100px;" type="button"
											...
											onclick="window.location.href='dokter.php';"></a>
								</div>
							</td>
						</tr>
						<tr>
