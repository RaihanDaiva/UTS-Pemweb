...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                ...
                <table>
                    <input type="hidden" name="type" value="rekam_medis">
                    <tr>
                    ...
                    <tr>
                        <td>No Dokter</td>
                        <td>
                            <select type="form-select" class="form-control" name="id_dokter" id="id_dokter" required>
                    ...
                    <tr>
                        <td>Diagnosa</td>
                        <td><input type="text" class="form-control" name="diagnosa"></td>
                    </tr>
                    <tr>
                        <td>Tanggal Kunjungan</td>
                        <td><input type="date" class="form-control" name="tanggal_kunjungan"></td>
                    </tr>
                    <tr>
                        <td>Tindakan Medis</td>
                        <td><input type="text" class="form-control" name="tindakan_medis"></td>
                    </tr>
                    <tr>
                        <td>Obat Diberikan</td>
                        <td><input type="text" class="form-control" name="obat_diberikan"></td>
                    </tr>
                    <tr>
                        <td>
