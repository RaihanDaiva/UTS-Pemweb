...
$query_admin = "SELECT id_admin, nama_admin FROM administrasi";
...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                ...
                <table>
                    <input type="hidden" name="type" value="pembayaran">
                    <tr>
                        <td class>Waktu Pembayaran</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><select type="form-select" class="form-control" name="status_pembayaran">
                    ...
                    <tr>
                        <td>Jumlah</td>
                        <td><input type="text" class="form-control" name="jumlah_pembayaran"></td>
                    </tr>
                    <tr>
                        <td>Metode Pembayaran</td>
                        <td><select type="form-select" class="form-control" name="metode_pembayaran">
                                <option value="">Pilih Status</option>
                    ...
                    <tr>
                        <td>No Pasien</td>
                        <td>
                            <select type="form-select" class="form-control" name="id_pasien" id="id_pasien" required>
                    ...
                    <tr>
                        <td>No Kasir</td>
                        <td>
                            <select type="form-select" class="form-control" name="id_admin" id="id_admin" required>
                                <option value="">Pilih Kasir</option>
                                <?php
                                // Loop untuk menampilkan data id_pasien dalam <option>
                                while ($row = $result_admin->fetch_assoc()) {
                                    echo "<option value='" . $row['id_admin'] . "'>" . $row['id_admin'] . " - " . $row['nama_admin'] . "</option>";
                                }
                                ?>
                            </select>
                        </td>
                        ...
                        <td class="pt-3">
                            <div class="d-flex justify-content-center gap-2 ">
                                ...
                                <a><input style="width:100px;" type="button"
                                        ...
                                        onclick="window.location.href='pembayaran.php';"></a>
                            </div>
                        </td>
                    </tr>
                    <tr>
