...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                        ...
                        <table>
                            <input type="hidden" name="action" value="updatePasien">
                            <tr>
                                <td class>Nama</td>
                                <td><input type="hidden" name="id_pasien" value="<?php echo $d['id_pasien']; ?>">
                                    <input type="text" class="form-control" name="nama_pasien"
                                        value="<?php echo $d['nama_pasien']; ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>Tanggal Lahir</td>
                                <td><input type="text" class="form-control" name="tanggal_lahir"
                                        value="<?php echo $d['tanggal_lahir']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Jenis Kelamin</td>
                                <td><input type="text" class="form-control" name="jenis_kelamin"
                                        value="<?php echo $d['jenis_kelamin']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Alamat</td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="no_telp"
                                        value="<?php echo $d['no_telp']; ?>"></td>
                            </tr>
                            <tr>
                                <td>Riwayat Penyakit</td>
                                <td><input type="text" class="form-control" name="riwayat_penyakit"
                                        value="<?php echo $d['riwayat_penyakit']; ?>"></td>
                            </tr>
                            <tr>
                                <td>Riwayat Pengobatan</td>
                                <td><input type="text" class="form-control" name="riwayat_pengobatan"
                                        value="<?php echo $d['riwayat_pengobatan']; ?>"></td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td class="pt-3">
                                    <div class="d-flex justify-content-center gap-2 ">
                                        ...
                                        <a><input style="width:100px;" type="button"
                                                ...
                                                onclick="window.location.href='pasien.php';"></a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
