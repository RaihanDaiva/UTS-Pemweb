...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Jenis Kelamin</td>
                            <td><select type="form-select" id="jenisKelamin" class="form-control" name="jenis_kelamin">
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="riwayat_penyakit"></td>
                        </tr>
                        <tr>
                            <td>Riwayat Pengobatan</td>
                            <td><input type="text" class="form-control" name="riwayat_pengobatan"></td>
                        </tr>
                        <tr>
                            <td>
