...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                ...
                <table>
                    ...
                    <tr>
                        <td>No Lisensi</td>
                        <td><input type="text" class="form-control" name="no_lisensi"></td>
                    </tr>
                    <tr>
                        <td>Spesialisasi</td>
                        <td><input type="text" class="form-control" name="spesialisasi"></td>
                    </tr>
                    <tr>
                        <td>Jadwal Praktek</td>
                        <td><input type="text" class="form-control" name="jadwal_praktek"></td>
                    </tr>
                    <tr>
                        <td>Kontak</td>
