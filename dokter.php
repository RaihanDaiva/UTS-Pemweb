                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($d = mysqli_fetch_array($data)) {
                                                            ...
                                                            <tr class="data">
                                                                ...
                                                                <td class="text-dark"><?php echo $d['nama_dokter']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['nomor_lisensi']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['spesialisasi']; ?>
                                                                </td>
                                                                <td class="text-dark">
                                                                    <?php echo $d['jadwal_praktek']; ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <a role="button" class="btn"
                                                                        ...
                                                                        href="ubah_dokter.php?id=<?php echo $d['id_dokter']; ?>">
                                                                    ...
                                                                    <a role="button" class="btn btn-danger"
                                                                        href="hapus.php?id=<?php echo $d['id_dokter']; ?>&type=dokter"><i
