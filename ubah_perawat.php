                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu show bg-transparent border-0">
                            ...
                            <div class="dropdown-submenu show bg-transparent border-0">
                                ...
                                <a href="perawat.php" class="dropdown-item active" style="margin-left:10px ;">Perawat</a>
...
">
        ...
        include 'koneksi.php';
        $id = $_GET['id'];
        $data = mysqli_query($koneksi, "select * from perawat where id_perawat='$id'");
...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                    ...
                    <table>
                        <input type="hidden" name="action" value="updatePerawat">
                        <tr>
                            <td class>Nama</td>
                            <td><input type="hidden" name="id_perawat" value="<?php echo $d['id_perawat']; ?>">
                                <input type="text" class="form-control" name="nama_perawat"
                                    value="<?php echo $d['nama_perawat']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>No Lisensi</td>
                            <td><input type="text" class="form-control" name="nomor_lisensi"
                                    value="<?php echo $d['nomor_lisensi']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Jadwal Kerja</td>
                            <td><input type="text" class="form-control" name="jadwal_kerja"
                                    value="<?php echo $d['jadwal_kerja']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Pengalaman</td>
                            <td><input type="text" class="form-control" name="pengalaman"
                                    value="<?php echo $d['pengalaman']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Kontak</td>
                            <td><input type="text" class="form-control" name="kontak" value="<?php echo $d['kontak']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="pt-3">
                                <div class="d-flex justify-content-center gap-2 ">
                                    ...
                                    <a><input style="width:100px;" type="button"
                                            ...
                                            onclick="window.location.href='perawat.php';"></a>
                                </div>
                            </td>
                        </tr>
                        <tr>
