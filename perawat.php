...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($d = mysqli_fetch_array($data)) {
                                                            ...
                                                            <tr class="data">
                                                                ...
                                                                <td class="text-dark"><?php echo $d['nama_perawat']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['nomor_lisensi']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['jadwal_kerja']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['pengalaman']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['kontak']; ?></td>

                                                                <td>
                                                                    <a role="button" class="btn"
                                                                        style="background-color: #002d72;"
                                                                        href="ubah_perawat.php?id=<?php echo $d['id_perawat']; ?>">
                                                                    ...
                                                                    <a role="button" class="btn btn-danger"
                                                                        href="hapus.php?id=<?php echo $d['id_perawat']; ?>&type=perawat"><i
            ...
            <!-- Tambah Data -->
            <form method="POST" action="tambah_perawat.php">
