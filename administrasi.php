...
-moz-box-shadow: 0px 0px 22px 0px rgba(0,0,0,0.22);">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($d = mysqli_fetch_array($data)) {
                                                            ...
                                                            <tr class="data">
                                                                ...
                                                                <td class="text-dark"><?php echo $d['nama_admin']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['jadwal_kerja']; ?>
                                                                </td>
                                                                <td class="text-dark"><?php echo $d['kontak']; ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <a role="button" class="btn"
                                                                        ...
                                                                        href="ubah_administrasi.php?id=<?php echo $d['id_admin']; ?>">
                                                                    ...
                                                                    <a role="button" class="btn btn-danger"
                                                                        href="hapus.php?id=<?php echo $d['id_admin']; ?>&type=admin "><i
            ...
            <!-- Tambah Data -->
            <form method="POST" action="tambah_administrasi.php">
